...
@section('content')
    @include('includes.progress')
                        @if($users)
                            {!! Form::open(['method'=>'POST','action'=>'VoltOrganizerController@index','files'=>true])!!}
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <th colspan="3">
                                        {!! Form::submit('Vote',['class'=>'btn btn-primary float-right','onclick'=>"return confirm('Are You Sure You want to vote for the Organizer Position?')"]) !!}
                                    </th>
                                </tr>
                                </tbody>
                            </table>
